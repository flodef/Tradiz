...
module.exports = {
    ...
    theme: {
        extend: {
            ...
            colors: {
                'writing-light': 'var(--writing-light-color)',
                'main-from-light': 'var(--main-from-light-color)',
                'main-to-light': 'var(--main-to-light-color)',
                'popup-light': 'var(--popup-light-color)',
                'active-light': 'var(--active-light-color)',
                'secondary-light': 'var(--secondary-light-color)',
                'secondary-active-light': 'var(--secondary-active-light-color)',
                'writing-dark': 'var(--writing-dark-color)',
                'main-from-dark': 'var(--main-from-dark-color)',
                'main-to-dark': 'var(--main-to-dark-color)',
                'popup-dark': 'var(--popup-dark-color)',
                'active-dark': 'var(--active-dark-color)',
                'secondary-dark': 'var(--secondary-dark-color)',
                'secondary-active-dark': 'var(--secondary-active-dark-color)',
                ok: colors.green['500'],
