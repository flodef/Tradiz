...
UPDATE dc_pos.subscription SET billing_method = 'transfer' WHERE billing_method = 'invoice';
UPDATE dc_pos.subscription SET billing_method = 'card' WHERE billing_method = 'revolut';
ALTER TABLE dc_pos.subscription ALTER COLUMN billing_method SET DEFAULT 'transfer';
